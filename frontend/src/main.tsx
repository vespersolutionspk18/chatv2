...
const registerServiceWorker = () => {
  // @ts-ignore
  window.frappePushNotification = new FrappePushNotification("chatly")

  if ("serviceWorker" in navigator) {
    // @ts-ignore
    window.frappePushNotification
      .appendConfigToServiceWorkerURL("/assets/chatly/chatly/sw.js")
      .then((url: string) => {
...
if (import.meta.env.DEV) {
  fetch('/api/method/chatly.www.chatly.get_context_for_dev', {
    method: 'POST',
  })
