...
export const ViewWebhookPage = ({ data, mutate }: { data: FrappeDoc<ChatlyWebhook>, mutate: KeyedMutator<FrappeDoc<ChatlyWebhook>> }) => {

    const methods = useForm<ChatlyWebhook>({
        defaultValues: {
            ...data,
    ...
    const onSubmit = async (data: FieldValues) => {
        return updateDoc('Chatly Webhook', data.name, data)
            .then((doc) => {
    ...
    const onUpdateEnabled = () => {
        updateDoc('Chatly Webhook', data.name, {
