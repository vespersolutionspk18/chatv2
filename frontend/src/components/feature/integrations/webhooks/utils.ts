...
export const DoctypeFieldList: {
    doctype: 'Chatly Message' | 'Chatly Channel' | 'Chatly Channel Member' | 'Chatly User' | 'Chatly Message Reaction',
    events: string[]
    fields: FieldsData[]
}[] = [
        {
        ...
        examples: [
            {
                ...
                fields: [
                    ...
                    {
                        field: 'file',
                        value: 'https://chatlyapp.info/_astro/app-screenshot.e5f6e34e.png'
                    },
                    {
