...
import { AddChatlyUsers } from '@/components/feature/chatly-users/AddChatlyUsers'
...
export const SidebarFooter = ({ isSettingsPage = false }: { isSettingsPage?: boolean }) => {
    ...
    const { myProfile } = useCurrentChatlyUser()
    ...
    return (
        ...
        >
                        ...
                        <DropdownMenu.Content variant='soft'>
                            ...
                            {canAddUsers && isDesktop &&
                                <DropdownMenu.Item color='gray' onClick={() => setIsAddUserModalOpen(true)} className={'flex justify-normal gap-2'}>
                                    <TbUsersPlus size='14' /> Add users to Chatly
                                </DropdownMenu.Item>
                            }
            ...
            <AddChatlyUsers isOpen={isAddUserModalOpen} onOpenChange={setIsAddUserModalOpen} />
