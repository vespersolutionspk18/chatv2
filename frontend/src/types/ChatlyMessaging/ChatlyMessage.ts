import { ChatlyMention } from './ChatlyMention'

export interface ChatlyMessage{
	creation: string
	name: string
	modified: string
	owner: string
	...
	/**	Is Reply : Check	*/
	is_reply?: 0 | 1
	/**	Replied Message ID : Link - Chatly Message	*/
	...
	/**	Is Edited : Check	*/
	is_edited?: 0 | 1
	/**	Mentions : Table - Chatly Mention	*/
	mentions?: ChatlyMention[]
	/**	Poll ID : Link - Chatly Poll	*/
	poll_id?: string
	/**	Is Bot Message : Check	*/
	is_bot_message?: 0 | 1
	/**	Bot : Link - Chatly User	*/
	bot?: string
