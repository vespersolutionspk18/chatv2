...
import { ChatlySchedulerEvent } from "@/types/ChatlyIntegrations/ChatlySchedulerEvent"
...
export const List = ({ data }: { data: ChatlySchedulerEvent[] }) => {
...
const ScheduledMessageItem = ({ item }: { item: ChatlySchedulerEvent }) => {
                ...
                <Flex direction={'row'} gap={'2'} align={'center'}>
                    ...
                    <AlertDialog.Root open={open} onOpenChange={setOpen}>
                        ...
                        <AlertDialog.Content className={DIALOG_CONTENT_CLASS}>
                            <AlertContent doctype="Chatly Scheduler Event" docname={item.name} onClose={onClose} />
                        </AlertDialog.Content>
                    </AlertDialog.Root>
                </Flex>
            </Flex>
