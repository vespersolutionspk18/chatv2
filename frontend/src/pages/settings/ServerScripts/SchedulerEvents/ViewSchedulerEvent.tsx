...
const ViewSchedulerEvent = (props: Props) => {
    ...
    const { data: eventData, error, mutate } = useFrappeGetDoc('Chatly Scheduler Event', ID)
...
const ViewSchedulerEventPage = ({ data, onUpdate }: { data: any, onUpdate: () => void }) => {
    ...
    const onSubmit = (data: any) => {
        ...
        updateDoc('Chatly Scheduler Event', data.name, {
            channel: data.channel,
            bot: data.bot,
            event_frequency: data.event_frequency,
                ...
                <Box className="lg:mx-[10rem] md:mx-[5rem] mt-9 h-screen">
                    ...
                    <Flex justify={'between'} mt={'6'}>
                        ...
                        <Flex gap={'3'}>
                            ...
                            <DeleteAlert doctype="Chatly Scheduler Event" docname={data.name} isOpen={isOpen} onClose={onClose} path={'../../scheduled-messages'} />
                        </Flex>
                    </Flex>
                    <Section size={'2'}>
